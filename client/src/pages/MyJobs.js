...
<Box component="fieldset" borderColor="transparent" className="mt-1 pt-0">
     ...
     <Grid item xs={12} className="pt-0">
        <CardContent className="pt-0" >
          <Typography component="h5" variant="h5">
            Location: 1600 Amphitheatre Pkwy, Mountain View, CA 94043, United States
          </Typography>
        </CardContent>
     </Grid>
...
direction="column"
>
<Avatar alt="Remy Sharp" src={require("../images/1a350ede83e5c0c4b87586c0d4bad0f66b86da37.png")} className={classes.bigAvatar}/>
</Grid>
